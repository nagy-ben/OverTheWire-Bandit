...
## Solution:
New windows has OpenSSH client, so I can use cmd or powershell to connect.
* The command is: **ssh bandit0@bandit.labs.overthewire.org -p 2220** where -p 2220 gives the port to use.
